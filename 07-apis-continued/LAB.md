...
- You are welcome to utilize the demo code from yesterday's lecture.
...
- When writing your `getWeather` callback, use `.map` and send the resulting array as your response to the client. Continue to use `.map` for the remainder of labs 7, 8, and 9.
...
### Feature #3: Retrieve restaurant information
...
### Feature #4: Retrieve movie information
