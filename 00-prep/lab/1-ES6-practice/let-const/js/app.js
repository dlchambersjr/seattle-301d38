...
function displayPics() {
  ...
  // David: The variable "rando" was defined within the scope of a while loop in the function displayPics.  Thus, "rando" is limited to that scope only.  The console.log request is outside of the while loop's scope and doesn't have access to the variable.
