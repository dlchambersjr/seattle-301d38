...
// FIXME: Uncomment the following line of code to see the output in the browser console
...
// DAVID: "this" referes to an instance of the Student Constructor

// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" refers to the "window" object

// 3. Explain why "this" is different when an arrow function is used.
// When an arrow function encounter "this" it bubbles it up to the highest object, which is the window.
